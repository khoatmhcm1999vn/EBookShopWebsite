    ...
    return (
      <form role="form" onSubmit={handleSubmit}>
        <div class="card-body">
          ...
          <div class="row">
            <Link to="/supplier" className="btn btn-outline-warning float-left">
              Back
            </Link>
        ...
        <div className="container-fluid">
          <div className="row mb-2">
            ...
            <div className="col-sm-6">
              {/* <h1 className="m-0 text-dark">Update Category</h1> */}
            </div>
          </div>
          {/* /.row */}
        </div>
          ...
          <Formik
            ...
            initialValues={
              supplierReducer.result
                ...
                : {
                    name: "",
                    // tel: "", address: "", vat: "", email: ""
                  }
            }
            onSubmit={(values, { setSubmitting }) => {
              dispatch(
                supplierActions.Update(user._id, token, values, props.history)
              );
              setSubmitting(false);
            }}
