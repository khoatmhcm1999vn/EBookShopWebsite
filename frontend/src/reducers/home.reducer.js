...
const book = (
  state = {
    ...
    dataFlashSalesProductTop10: [],
    // dataListProductSearch: [],
    currency: "VND"
  },
  action
) => {
  switch (action.type) {
    ...
    // case homeTypes.SET_LIST_PRODUCT_SEARCH: {
    //   return {
    //     ...state,
    //     dataListProductSearch: action.payload.products,
    //   };
    // }
    case homeTypes.SET_PRODUCT_NAME_SEARCH_BY_ID: {
      return {
        ...state,
        nameProductSearch: action.payload.data
      }
    }
    ...
    case homeTypes.SET_LIST_FLASH_SALES_PRODUCT_TOP_10: {
      return {
        ...state,
        dataFlashSalesProductTop10: action.payload.data
      }
    }
